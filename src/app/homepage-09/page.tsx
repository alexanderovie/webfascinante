...
export const metadata: Metadata = {
  title: 'Cloud Based Software - Fascinante Digital',
  description: 'Cloud Based Software of Fascinante Digital',
};
const HomePage09 = () => {
  return (
    <>
      ...
      <main className="bg-background-2 dark:bg-background-5">
        ...
        <CTAV1
          ...
          description="Start your free trial today and experience the power of Fascinante Digital—where efficiency meets innovation."

...
export const metadata: Metadata = {
  title: 'Financial Application - Fascinante Digital',
  description:
    'Discover Fascinante Digital, a comprehensive financial application designed to streamline your business finances, enhance productivity, and drive growth.',
};

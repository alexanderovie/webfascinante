      ...
      <div
        ...
        <div className="space-y-6 p-6">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mr-1 badge-uppercase" style={{backgroundColor: '#DCFCE6', color: '#166534', border: '1px solid #DCFCE6'}}>
              <Link href={`/blog-03?category=${blog?.tag.toLowerCase()}`}>{blog?.tag.toUpperCase()}</Link>
            </span>

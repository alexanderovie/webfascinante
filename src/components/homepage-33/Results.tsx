        ...
        <div className="main-container">
          <div className="space-y-14 mb-[70px] text-center sm:text-left mx-4 sm:mx-0">
            <div className="space-y-3">
              <RevealAnimation delay={0.1}>
                <h2 className="text-secondary dark:text-accent heading-title-case">Results that speak for themselves.</h2>
              </RevealAnimation>
                ...
                {resultCards.map((result, index) => (
                  <div
                    ...
                    <div className="transition-all duration-700 ease-in-out transform group-hover:translate-y-[4px]">
                      <p className="group-hover:text-white text-secondary/60 dark:text-accent/60 text-lg mb-2 transition-colors duration-700 ease-in-out heading-title-case">
                        {result.category}
                      </p>

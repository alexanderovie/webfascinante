        ...
        <div className="main-container">
          <div className="flex flex-col md:flex-row items-start max-md:gap-y-18 md:gap-x-[120px] justify-center md:justify-between">
            ...
            <div className="lg:sticky lg:top-28">
              <RevealAnimation delay={0.1}>
                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200 mb-5 badge-uppercase">SERVICES OVERVIEW</span>
              </RevealAnimation>
              <div className="space-y-2 md:max-w-[595px] mb-14">
                <RevealAnimation delay={0.2}>
                  <h2 className="heading-title-case">Our Performance-Focused Services.</h2>
                </RevealAnimation>
              ...
              {servicesData.map((service) => (
                <StackCardItem key={service.id}>
                  <div
                    ...
                    <div>
                      <h3 className="text-heading-5 heading-title-case">{service.title}</h3>

              ...
              <div className="md:w-full space-y-7 text-center md:text-left">
                <div className="md:w-full space-y-3">
                  <RevealAnimation delay={0.2}>
                    <h2 className="max-w-[571px] text-accent heading-title-case">Why Fascinante Digital?</h2>
                  </RevealAnimation>
                  ...
                  {leftFeatures.map((feature, index) => (
                    <RevealAnimation key={feature.id} delay={0.5 + index * 0.1} direction="left">
                      <div className="space-y-4">
                        ...
                        <div>
                          <h3 className="text-tagline-1 font-medium text-accent heading-title-case">{feature.title}</h3>

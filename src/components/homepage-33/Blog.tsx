      ...
      <div className="main-container">
        <div className="text-center mb-[70px]">
          <RevealAnimation delay={0.1}>
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200 mb-5 badge-uppercase">BLOG</span>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <h2 className="mb-3 heading-title-case">Actionable Insights From Real Experts.</h2>
          </RevealAnimation>

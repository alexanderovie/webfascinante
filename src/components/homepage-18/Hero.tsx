        ...
        <div className="text-left md:text-center max-md:pt-[150px] max-lg:pt-[200px]">
          ...
          <RevealAnimation delay={0.3}>
            <p className="max-w-[650px] mx-auto mb-6">
              &nbsp;Save time and elevate your business with intelligent workflow automation from Fascinante Digital.
            </p>
          </RevealAnimation>
              ...
              <div className="mb-9">
                ...
                <RevealAnimation delay={0.3}>
                  <p className="max-w-[530px]">
                    At Fascinante Digital, we leverage AI and strategic insight to enhance business performance. Partner with us

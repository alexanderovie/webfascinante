      ...
      <div className="main-container mb-[70px]">
        <RevealAnimation delay={0.1}>
          <div className="space-y-3 text-center">
            <h2>Welcome to the Fascinante Digital documentation</h2>
            <p>Find everything you need to set up, customize, and master your Fascinante Digital platform.</p>
          </div>
        </RevealAnimation>
      </div>
                  ...
                  <ul className="space-y-3 list-disc list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
                    <li>
                      <Link
                        ...
                        Introduction to Fascinante Digital
                      </Link>
                    </li>
                    <li>
                      <Link
          ...
          <RevealAnimation delay={0.7}>
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p>Tailor Fascinante Digital to fit your business needs.</p>
              </div>
              <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
                <li>
                  <Link

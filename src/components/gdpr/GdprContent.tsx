...
const GdprContent = () => {
  ...
  const dataPurposes: ListItem[] = [
    { id: 'account-management', text: 'To create and manage your Fascinante Digital account' },
    ...
    <section className="pt-[100px] pb-[200px]">
      <div className="main-container">
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              ...
              <p>
                ...
                <br />
                <br />
                This page explains how Fascinante Digital implements GDPR principles and ensures that your data is handled
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p>
                  At Fascinante Digital, we are fully committed to respecting your privacy. This page provides a clear overview
                  of:
                </p>
              </div>
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-3">
              ...
              <p>
                ...
                Fascinante Digital) must be transparent about what data they collect, how they use it, and how they share it — and
          ...
          {/* How Fascinante Digital Implements GDPR */}
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How Fascinante Digital Implements GDPR</h3>
              <p>
                Fascinante Digital has always prioritized user data privacy, even before GDPR came into effect. Our core practices

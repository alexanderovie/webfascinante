...
const testimonialReviews: TestimonialReview[] = [
  {
    ...
    position: '@lana_stone',
    image: avatar6,
    text: 'Fascinante Digital helped me shift from passive saving to active investing—with zero stress.',
  },
  {
    id: 2,
    name: 'Sarah Johnson',
  ...
  },
  {
    ...
    position: '@mike_chen',
    image: avatar8,
    text: "I've seen a 40% increase in my portfolio since switching to Fascinante Digital. Highly recommended!",
  },
];

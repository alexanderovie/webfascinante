        ...
        <div className="space-y-[75px] privacy-policy">
          ...
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                <span className="text-secondary dark:text-accent">Fascinante Digital</span> is a product operated by
                <span className="text-secondary dark:text-accent">Fascinante Digital Technologies LLC</span>. We specialize in
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-2">
              <h4>Fascinante Digital privacy policy</h4>
              <p>

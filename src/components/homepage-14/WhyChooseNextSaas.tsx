...
const WhyChooseNextSaas = () => {
  return (
    <section className="py-20 md:py-[90px] lg:py-[100px]" aria-label="Why choose Fascinante Digital">
          ...
          <div className="space-y-[70px]">
            ...
            <div className="space-y-[20px] text-center md:text-left">
              <RevealAnimation delay={0.2}>
                <span className="badge badge-yellow">Why choose Fascinante Digital?</span>
              </RevealAnimation>

        ...
        <div className="space-y-[70px] changelog">
          <div className="space-y-3 text-center">
            <RevealAnimation delay={0.3}>
              <h2>Fascinante Digital changelog</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p>Stay updated with the latest features, improvements, and fixes in Fascinante Digital.</p>
            </RevealAnimation>
          </div>
          <div className="space-y-8">
            ...
            <RevealAnimation delay={0.6}>
              <div className="bg-background-2 dark:bg-background-6 px-[42px] py-14 space-y-6 rounded-[20px] relative overflow-hidden z-10 max-w-[850px] mx-auto">
                ...
                <h4 className="mb-6">Fascinante Digital v2.2.0 – released on april 25, 2025</h4>
                <div className="space-y-8">
          ...
          <RevealAnimation delay={0.7}>
            <div className="bg-background-2 dark:bg-background-6 px-[42px] py-14 space-y-6 rounded-[20px] relative overflow-hidden z-10 max-w-[850px] mx-auto">
              ...
              <h4 className="mb-6">Fascinante Digital v2.1.0 – Released on March 10, 2025</h4>
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-secondary dark:text-accent">New:</p>
                  <ul className="space-y-3 list-disc list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
          ...
          <RevealAnimation delay={0.8}>
            <div className="bg-background-2 dark:bg-background-6 px-[42px] py-14 space-y-6 rounded-[20px] relative overflow-hidden z-10 max-w-[850px] mx-auto">
              ...
              <h4 className="mb-6">Fascinante Digital v2.0.0 – major update – released on february 1, 2025</h4>
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-secondary dark:text-accent">New:</p>
                  <ul className="space-y-3 list-disc list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
                    <li>Full platform UI redesign</li>
                    <li>Launch of Fascinante Digital Mobile App (iOS and Android)</li>
          ...
          <RevealAnimation delay={0.9}>
            <div className="bg-background-2 dark:bg-background-6 px-[42px] py-14 space-y-6 rounded-[20px] relative overflow-hidden z-10 max-w-[850px] mx-auto">
              ...
              <h4 className="mb-6">Fascinante Digital v1.5.0 – Released on December 15, 2024</h4>
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-secondary dark:text-accent">New:</p>
                  <ul className="space-y-3 list-disc list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
          ...
          <RevealAnimation delay={1}>
            <div className="space-y-6 relative overflow-hidden z-10 max-w-[850px] mx-auto">
              <div className="space-y-3">
                <h4>Fascinante Digital v1.0.0 – Initial Release – October 1, 2024</h4>
